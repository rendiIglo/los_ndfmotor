...
WebUI.click(findTestObject('TC.02_Task Survey/txtPagingNo'))

not_run: WebUI.click(findTestObject('TC.02_Task Survey/btnLastPage'))

not_run: WebUI.delay(3)

not_run: WebUI.click(findTestObject('TC.02_Task Survey/btnFirstPage'))
