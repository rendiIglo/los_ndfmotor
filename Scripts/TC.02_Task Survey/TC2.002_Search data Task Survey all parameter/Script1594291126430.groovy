...
WebUI.setText(findTestObject('TC.02_Task Survey/txtCustomerName'), 'Sammy Rusliman')

WebUI.setText(findTestObject('TC.02_Task Survey/txtLeadID'), '20200630401L001688')
