...
WebUI.setText(findTestObject('TC.02_Task Survey/txtCustomerName'), 'a')

not_run: WebUI.setText(findTestObject('TC.02_Task Survey/txtLeadID'), '20200630401L001688')
...
WebUI.click(findTestObject('TC.02_Task Survey/btnNextPage'))
