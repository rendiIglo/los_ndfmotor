...
WebUI.setText(findTestObject('TC.02_Task Survey/txtScheduleDate'), '16/07/2020')

WebUI.setText(findTestObject('TC.02_Task Survey/txtScheduleTime'), '12:00')

not_run: WebUI.click(findTestObject('TC.02_Task Survey/ddlSurveyType'), FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.click(findTestObject('TC.02_Task Survey/ddlSurveyType - SilentSurvey'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('TC.02_Task Survey/btnSurveyScheduled'))

WebUI.setText(findTestObject('TC.02_Task Survey/popupUpdateSurvey/txtScheduleDate'), '20/10/2020')

WebUI.click(findTestObject('TC.02_Task Survey/popupUpdateSurvey/ddlSurveyStatus'))

WebUI.click(findTestObject('TC.02_Task Survey/popupUpdateSurvey/ddlSurveyStatus - BatalSurvey'))

WebUI.setText(findTestObject('TC.02_Task Survey/popupUpdateSurvey/txtNote'), 'Will be survey in the morning')

WebUI.click(findTestObject('TC.02_Task Survey/popupUpdateSurvey/btnSave'))

not_run: WebUI.click(findTestObject('TC.02_Task Survey/btnPickUp'))
