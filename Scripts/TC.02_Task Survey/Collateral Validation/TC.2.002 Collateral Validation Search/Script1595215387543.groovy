...
WebUI.click(findTestObject('Master/a_Collateral Validation'))
...
WebUI.click(findTestObject('TC.05_Funding_Preparation/Search By All Filed/Page_Home Page - My ASPNET Application/ComboBox_Branch'))

WebUI.click(findTestObject('TC.05_Funding_Preparation/Search By All Filed/Page_Home Page - My ASPNET Application/Branch'))

WebUI.click(findTestObject('TC.05_Funding_Preparation/Search By All Filed/Page_Home Page - My ASPNET Application/Combobox_PlatForm'))

WebUI.click(findTestObject('TC.05_Funding_Preparation/Search By All Filed/Page_Home Page - My ASPNET Application/span_Sharia'))

WebUI.setText(findTestObject('TC.05_Funding_Preparation/Search By All Filed/App Number'), '202005401LS00020')
