...
WebUI.setText(findTestObject('TC.02_Task Survey/txtCustomerName'), 'Kasic')

WebUI.setText(findTestObject('TC.02_Task Survey/txtLeadID'), '20200417401L000283')

WebUI.setText(findTestObject('TC.02_Task Survey/txtScheduleDate'), '22/01/2019')

WebUI.setText(findTestObject('TC.02_Task Survey/txtScheduleTime'), '20:14')
...
WebUI.click(findTestObject('TC.02_Task Survey/btnReset'))
