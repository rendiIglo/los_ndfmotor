...
WebUI.click(findTestObject('TC.03_Silent Survey/Source Checking/btn-add row'))

WebUI.click(findTestObject('TC.03_Silent Survey/Source Checking/dd_Source Checking'))

WebUI.click(findTestObject('TC.03_Silent Survey/Source Checking/dd_source checking-Tetangga jarak'))

WebUI.setText(findTestObject('TC.03_Silent Survey/Source Checking/txtDetail'), 'test')

WebUI.setText(findTestObject('TC.03_Silent Survey/Source Checking/txtName'), 'Destriani Saafitri')

WebUI.setText(findTestObject('TC.03_Silent Survey/Source Checking/txtMobile Phone'), '08452435243524352')

WebUI.delay(2)

WebUI.click(findTestObject('TC.03_Silent Survey/Source Checking/btn-save'))

WebUI.click(findTestObject('TC.02_Task Survey/btnOk'))

WebUI.delay(2)

WebUI.click(findTestObject('TC.03_Silent Survey/Source Checking/spanFoundFirst'))

WebUI.click(findTestObject('TC.03_Silent Survey/Source Checking/btn-Delete'))
