...
WebUI.setText(findTestObject('TC.04 Credit Analyst/input Application Date From From'), '01-Jul-2020')

WebUI.setText(findTestObject('TC.04 Credit Analyst/input Application Date From To'), '30-Jul-2020')

WebUI.setText(findTestObject('TC.04 Credit Analyst/input application number'), '202007401LS00312')

WebUI.setText(findTestObject('TC.04 Credit Analyst/input customer name'), 'Wulan')

WebUI.click(findTestObject('TC.04 Credit Analyst/select item product'))

WebUI.click(findTestObject('TC.04 Credit Analyst/pilih grid NDF Motor'))
