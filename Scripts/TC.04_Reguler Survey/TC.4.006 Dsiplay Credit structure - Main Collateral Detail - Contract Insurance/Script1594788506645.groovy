...
WebUI.click(findTestObject('TC.04_Reguler Survey/Credit Structure/TabCreditStructure'))

WebUI.scrollToElement(findTestObject('TC.04_Reguler Survey/Credit Structure/Scroll_ContracInsurance'), 5)
