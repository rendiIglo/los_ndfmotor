...
not_run: WebUI.click(findTestObject('TC.04_Reguler Survey/Survey Result/TabSurveyResult'))

not_run: WebUI.click(findTestObject('TC.04_Reguler Survey/Survey Result/checkbox Copy From Residence'))

not_run: WebUI.click(findTestObject('TC.04_Reguler Survey/Survey Result/upload image'))

not_run: CustomKeywords.'rendi.uploadNativePopUpWindow.uploadFile'(findTestObject('TC.04_Reguler Survey/Survey Result/upload image'), 
    'D:\\HAHAHAHA.jpg')

not_run: WebUI.click(findTestObject('TC.04_Reguler Survey/Survey Result/button save'))
