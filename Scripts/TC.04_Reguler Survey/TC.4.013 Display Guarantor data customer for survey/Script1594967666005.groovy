...
WebUI.click(findTestObject('TC.02_Task Survey/spanFoundFirst'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('TC.04_Reguler Survey/Guarantor/Tab Guarantor'))

not_run: WebUI.click(findTestObject('TC.04_Reguler Survey/Guarantor/Dropdown Guarantor'))

not_run: WebUI.click(findTestObject('TC.04_Reguler Survey/Guarantor/span_Personal Guarantor'))

not_run: WebUI.setText(findTestObject('TC.04_Reguler Survey/Guarantor/input NIK'), '1234232454353235')

not_run: WebUI.click(findTestObject('TC.04_Reguler Survey/Guarantor/dropdown Profession'))

not_run: WebUI.click(findTestObject('TC.04_Reguler Survey/Guarantor/span_WIRASWASTA'))

not_run: WebUI.click(findTestObject('TC.04_Reguler Survey/Guarantor/dropdown Relationship'))

not_run: WebUI.click(findTestObject('TC.04_Reguler Survey/Guarantor/span_Family'))

not_run: WebUI.setText(findTestObject('TC.04_Reguler Survey/Guarantor/input Name'), 'Verdi')

not_run: WebUI.setText(findTestObject('TC.04_Reguler Survey/Guarantor/input Monthly Income'), '10000000')

not_run: WebUI.click(findTestObject('TC.04_Reguler Survey/Guarantor/button Save'))

WebUI.takeScreenshot()

not_run: WebUI.click(findTestObject('TC.04_Reguler Survey/Guarantor/save'))
