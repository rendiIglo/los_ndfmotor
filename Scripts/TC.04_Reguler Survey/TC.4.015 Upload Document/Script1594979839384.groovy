...
WebUI.click(findTestObject('TC.04_Reguler Survey/Document/tab Document'))

WebUI.click(findTestObject('TC.04_Reguler Survey/Document/grid e-ktp'))

WebUI.click(findTestObject('TC.04_Reguler Survey/Document/button Upload'))

WebUI.setText(findTestObject('TC.04_Reguler Survey/Document/input Upload Receive By'), 'Bambang')

WebUI.click(findTestObject('TC.04_Reguler Survey/Document/icon calendar - Expired Date'))

WebUI.click(findTestObject('TC.04_Reguler Survey/Document/tanggal 04'))

WebUI.click(findTestObject('TC.04_Reguler Survey/Document/input attachment ektp'))

CustomKeywords.'rendi.uploadNativePopUpWindow.uploadFile'(findTestObject('TC.04_Reguler Survey/Document/input attachment ektp'), 
    'D:\\PANGERAN GANTENG.jpg')

WebUI.setText(findTestObject('TC.04_Reguler Survey/Document/input Document Number'), '12342345')

WebUI.click(findTestObject('TC.04_Reguler Survey/Document/button save'))
