...
WebUI.setText(findTestObject('TC.02_Collateral Validation/txtCustomerName'), 'Naomi')

WebUI.setText(findTestObject('TC.02_Collateral Validation/txtApplicationNumber'), '202007401LS00126')
