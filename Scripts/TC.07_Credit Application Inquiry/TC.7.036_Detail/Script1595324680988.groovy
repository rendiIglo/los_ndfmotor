...
WebUI.click(findTestObject('TC.07_Credit Application Inquiry/pilihan grid credit application inquiry'))

WebUI.click(findTestObject('TC.07_Credit Application Inquiry/button detail credit application inquiry'))
...
WebUI.click(findTestObject('TC.07_Credit Application Inquiry/button close detail CAI'))
